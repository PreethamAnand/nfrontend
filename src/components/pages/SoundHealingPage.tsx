...
import { getSounds } from "@/lib/contentApi";
...
export function SoundHealingPage() {
  ...
  const trackImages = soundLibrary.map((track, idx) =>
    track.thumbnailUrl || track.bannerUrl || fallbackImages[idx % fallbackImages.length]
  );
